...
import math
import torch
from neural_style.ops import *
from neural_style.transformer_net import TransformerNet, T_CHANNEL_CONFIG
...
def get_full_channel_configs(model):
    ...
    for m in model.modules():
        if isinstance(m, ConstantInput):
            ...
            full_channels.append(m.weight.shape[1])
...
def sort_channel(g):
    ...
    _reorg_input_channel(g.conv1.conv2d, sorted_idx)
